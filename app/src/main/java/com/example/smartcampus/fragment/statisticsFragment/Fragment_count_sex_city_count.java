...
public class Fragment_count_sex_city_count extends BaseFragment {
    
    private GetMunicipalMenAndWomenNumberAll getMunicipalMenAndWomenNumberAll;
    ...
    public Fragment_count_sex_city_count(GetMunicipalMenAndWomenNumberAll getMunicipalMenAndWomenNumberAll) {
        this.getMunicipalMenAndWomenNumberAll = getMunicipalMenAndWomenNumberAll;
    }
    
    @Override
    protected int layoutResId() {
        return R.layout.fragment_count_sex_city_count;
    }
    ...
    protected void initData() {
        title.setText("性别统计");
        txtProvince.setText(getMunicipalMenAndWomenNumberAll.getMunicipalName());
        double sum = getMunicipalMenAndWomenNumberAll.getMan() + getMunicipalMenAndWomenNumberAll.getWoman();
        double nv = getMunicipalMenAndWomenNumberAll.getWoman();
        double woman = nv / sum;
