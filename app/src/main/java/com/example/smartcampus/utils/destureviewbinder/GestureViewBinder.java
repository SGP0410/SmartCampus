package com.example.smartcampus.utils.destureviewbinder;
...
/**
 * Created by JarvisLau on 2018/5/30. Description :
 */
    ...
    private GestureViewBinder(Context context, ViewGroup viewGroup, final View targetView) {
        ...
        viewGroup.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ((MapView) targetView).getMyOnTouchEvent().onTouchEvent(event);
